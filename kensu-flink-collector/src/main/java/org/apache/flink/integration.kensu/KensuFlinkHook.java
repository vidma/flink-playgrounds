...
//    private AtlasEntity.AtlasEntitiesWithExtInfo entity;
    ...
    public static void logDebug(String msgFmt){
        String msg = String.format(msgFmt);
        System.out.println("org.apache.flink.integration.kensu - logInfo - " + msg);
        LOG.warn(msg);
    }
//
...
//            } else if (sinkOp instanceof org.apache.flink.streaming.runtime.operators.sink.SinkOperator) {
